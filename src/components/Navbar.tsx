    ...
    return (
        <NavbarBS className="bg-white shadow-lg mb-3">
            <Container>
              ...
              {cartQuantity > 0 ?  <Button style={{ width: '3rem', height: '3rem', position: 'relative' }} onClick={openCart}>
                    <svg
                        fill="#f2f2f2"
                        version="1.1"
                        id="Capa_1"
                    ...
                    <div className='rounded circle bg-danger d-flex justify-content-center align-items-center'>{cartQuantity}</div>
